  ...
  return (
    <div className="mt-5 ml-10 relative">
      <div className="flex items-start gap-3">
        ...
        {!disableAutoGen && (
          <button
            className="flex items-center gap-1.5 text-[13px] font-medium text-sky-500 bg-sky-50 py-0.5 rounded-full hover:bg-sky-500 hover:text-white cursor-pointer absolute top-0 right-0"
            disabled={loading}
