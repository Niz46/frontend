    ...
    <Modal isOpen={isOpen} onClose={() => setIsOpen(false)} hideHeader>
      <div className="p-4 w-[80vw] md:w-[40vw] mx-auto">
        ...
        <div className="relative mt-4 mb-1">
          ...
          <button className="w-8 h-8 flex items-center justify-center absolute right-2 top-1/2 transform -translate-y-1/2 text-white bg-sky-500 rounded cursor-pointer" onClick={handleSearch}>
