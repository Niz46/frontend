...
const MarkdonwContent = ({ content }) => {
  if (!content) return null;
  return (
    <div className="text-[14px] prose prose-slate dark:pose-invert max-w-none">
      <div className="">
        <ReactMarkDown
          ...
          components={{
            ...
            video({ src }) {
              return <video src={src} className="my-4 max-w-full rounded" controls playsInline loop />;
            },
          }}
        >
          {content}
...
export default MarkdonwContent;
